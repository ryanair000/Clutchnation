  ...
  if (sent) {
    return (
      <div className="mt-8 rounded-lg bg-accent-50 p-6 text-center">
        <h2 className="font-heading text-lg font-semibold text-accent-700">Check your email</h2>
  ...
  return (
    <div className="mt-8 space-y-6">
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-surface-300 bg-white px-4 py-2.5 text-sm font-medium text-ink hover:bg-surface-50 transition-colors"
      >
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-surface-50 px-2 text-ink-muted">or</span>
        </div>
      </div>
